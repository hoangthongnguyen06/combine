import requests
from app.endpoints import APISpyderEndpoints
from app.config import Config


def login_to_api():
    login_url = APISpyderEndpoints.LOGIN.value
    payload = {'username': Config.USERNAME_SPYDER,
               'password': Config.PASSWORD_SPYDER}
