    ...
    with app.app_context():
        ...
        try:
            ...
            scheduler.add_job(func=update_sentiment_topic_from_api, trigger="interval", minutes=0.5, args=(
                endpoints.APIPlatformEndpoints.SAC_THAI_THEO_CHU_DE.value, endpoints.APIPlatformEndpoints.LUOT_TUONG_TAC_THEO_CHU_DE, headers_platform, app))
            print(endpoints.APIPlatformEndpoints.LUOT_TUONG_TAC_THEO_CHU_DE)
