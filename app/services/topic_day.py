...
def update_sentiment_topic_from_api(api_url_sac_thai, api_url_tuong_tac, headers=None, app=None):
    ...
    def create_payloads(day):
        ...
        return payload_platform_sac_thai, payload_platform_tuong_tac, payload_spyder_sac_thai

    with app.app_context():
        current_date = start_date
        while current_date <= end_date:
            payload_platform_sac_thai, payload_platform_tuong_tac, payload_spyder_sac_thai = create_payloads(current_date)
